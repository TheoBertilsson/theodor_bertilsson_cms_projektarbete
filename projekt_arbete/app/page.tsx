  ...
  return (
    <main className="flex flex-col items-center justify-evenly h-[100vh] w-4/5">
      ...
      <section className="flex flex-wrap  justify-evenly gap-5 w-full">
        <a
          href="/projects"
          className="w-[350px] h-[270px] rounded-2xl border-border border-2 no-underline text-black flex justify-center items-center hover:bg-[#436850] hover:text-white hover:underline text-xl font-bold bg-foreground"
        >
          <h2>Projects</h2>
        </a>
        <a
          href="/about"
          className="w-[350px] h-[270px] rounded-2xl border-border border-2 no-underline text-black flex justify-center items-center hover:bg-[#436850] hover:underline text-xl font-bold hover:text-white bg-foreground"
        >
          <h2>About me</h2>
        </a>
        <a
